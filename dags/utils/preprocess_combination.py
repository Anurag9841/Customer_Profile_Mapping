...
from utils.Load_DF import load_df_from_dir,sanitize,string_to_digits,char_to_digit
...
def final_entity_matching():
    ...
    def save_layouts(layouts, save_path):
        ...
        return final_df
    return save_layouts(layouts,'/home/user/airflow/output_file/output_files_entity_matching')
